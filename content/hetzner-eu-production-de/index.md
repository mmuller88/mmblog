...
Dieselbe Arbeit als abgegrenztes Angebot: **[Vibe Coding und Production Readiness](https://martinmueller.dev/one-man-agency-de/vibe-coding/)**. [Termin buchen](https://calendly.com/martinmueller_dev/30min) oder eine Nachricht von der Seite.
...
Training: [EU-Produktion auf Hetzner](/trainings-de/hetzner-eu-production/) — zweitägiges Team-Training, vor Ort oder remote, Preis auf Anfrage.
