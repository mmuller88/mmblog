...
description: "Shipping a Next.js MVP on AWS with OpenNext and CDK instead of ECS Fargate: one GitHub Actions deploy, lower run cost than always-on tasks."
show: "yes"
date: "2026-09-21"
image: "index.png"
audio: "audio.mp3"
...
This post is the walkthrough. The course is the build — the same path as [qr-plakat.de](https://qr-plakat.de).
...
**[Next.js MVP: OpenNext + CDK](/trainings/opennext-cdk-mvp/)** — three-day team training, on-site or remote, price on request.
