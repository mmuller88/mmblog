---
title: Security, Best Practice and Hardening Checks with Prowler
date: '2021-08-25'
image: 'logo.png'
...
To run the Prowler scan again, you just have to run the AMI or the Ec2 instance with the AMI again. The Prowler stack will be triggered to run the scan again.
